...
from random import *
from helper import plot_blackjack

blackjack_env = gym.make('Blackjack-v1')

def every_visit_mc_control(env, train_policy_func, epsilon, alpha, noe, noi):
...
q_table = every_visit_mc_control(blackjack_env, train_policy_func, 0.10, 0.4, 10000, 10000)
